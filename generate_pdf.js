...
const tex = fs.readFileSync(path.join(__dirname, 'chapitre4_complet.tex'), 'utf-8');
...
const htmlPath = path.join(__dirname, 'chapitre4_complet.html');
...
(async () => {
  ...
  const pdfPath = path.join(__dirname, 'Chapitre4_Validation_Fonctionnelle.pdf');
  await page.pdf({
    path: pdfPath,
    format: 'A4',
